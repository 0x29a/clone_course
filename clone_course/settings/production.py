...
from clone_course.settings.utils import get_env_setting
...
# This may be overridden by the YAML in clone_course_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

if 'CLONE_COURSE_CFG' in environ:
    CONFIG_FILE = get_env_setting('CLONE_COURSE_CFG')
