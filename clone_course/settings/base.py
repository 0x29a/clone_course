...
from clone_course.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('CLONE_COURSE_SECRET_KEY', 'insecure-secret-key')
...
PROJECT_APPS = (
    'clone_course.apps.core',
    'clone_course.apps.api',
)
...
ROOT_URLCONF = 'clone_course.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'clone_course.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'clone_course.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'clone_course_sessionid'
CSRF_COOKIE_NAME = 'clone_course_csrftoken'
LANGUAGE_COOKIE_NAME = 'clone_course_language'
...
# Celery Broker
CELERY_BROKER_URL = 'redis://:password@edx.devstack.redis:6379/10'
CELERY_BROKER_POOL_LIMIT = 1

CELERY_TASK_ALWAYS_EAGER = False

CELERY_RESULT_BACKEND = 'redis://:password@edx.devstack.redis:6379/0'
