"""
clone_course URL Configuration.
...
from clone_course.apps.api import urls as api_urls
from clone_course.apps.core import views as core_views
...
urlpatterns = oauth2_urlpatterns + [
    ...
    re_path(r'^api-docs/', get_swagger_view(title='clone_course API')),
