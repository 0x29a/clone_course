...
"""
clone_course documentation build configuration file.
...
VERSION = get_version('../clone_course', '__init__.py')
...
project = 'clone_course'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'clone_course'
...
html_context = {
    ...
    "github_repo": 'clone_course',  # Repo name
...
#
# html_title = 'clone_course v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'IDA for cloning courses',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'clone_course'),
                os.path.join(root_path, 'clone_course/migrations')])
